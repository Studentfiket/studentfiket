  ...
  return (
    <div className='w-full'>
      ...
      <div className='absolute top-0 w-full h-full -z-20'>
        ...
        <div className="absolute inset-0 bg-coffee bg-opacity-10 backdrop-blur-md"></div>
      ...
      <div
        className="flex flex-col top-0 w-full -z-20"
      >
        {/* Hero */}
        ...
        {/* Info */}
        <div className="relative rounded-t-2xl bg-white shadow-lg">
          <div className="md:w-3/4 flex flex-col gap-y-4 px-4 items-center mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center my-12 gap-y-4 gap-x-8">
              <IconWithText
                icon={<FiCoffee size={24} className="text-orange-600" />}
                title="Besök oss"
                description={
                  <p className="text-sm">
              ...
              <IconWithText
                icon={<FiCalendar size={24} className="text-orange-600" />}
                title="Boka ett pass"
                description={
                  <p className="text-sm">
